...
var Timepicker = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Timepicker, [{
    ...
    value: function renderItem(i) {
      ...
      var onClick = this.props.onChange.bind(this, i);
    ...
    value: function render() {
      ...
      while (time.isSameOrBefore(maxTime)) {
        times.push(time);
        time = (0, _moment.default)(time).add(p.timeStep > 0 ? p.timeStep : 60, 'minutes');
      }
      ...
      return /*#__PURE__*/_react.default.createElement(TimepickerStyled, {
        ...
        horisontal: false,
        speed: 0.8
      }, times.map(function (t, n) {
        return _this.renderItem(t);
      })), /*#__PURE__*/_react.default.createElement("button", {
